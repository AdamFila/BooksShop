...
import static com.example.android.booksshop.data.BookContract.CONTENT_AUTHORITY;
import static com.example.android.booksshop.data.BookContract.PATH_BOOKS;
...
public class BookProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case BOOKS:
                // For the BOOKS code, query the books table
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        String supplier_phone_number = values.getAsString(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE_NUMBER);
        if (TextUtils.isEmpty(supplier_phone_number)){
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case BOOKS:
                ...
                rowsDeleted = database.delete(BookEntry.TABLE_NAME, selection, selectionArgs); break;
            case BOOK_ID:
